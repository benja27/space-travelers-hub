...
function Missions() {
  ...
  return (
    ...
    <tbody>
        {
            array.map((arr)=>(
                <MissionCard name={arr.mission_name} description={arr.description} key={arr.mission_id}/>
            ))
